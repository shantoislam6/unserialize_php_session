...
const unserialize = require('../unserialize_php_session.js')
...
describe('special cases test', function () {
  it('CJK string', function (done) {
    const expected = { bangla: 'ইনপুট সরঞ্জাম', arbic: 'لوحة المفاتيح', chinese: '中文鍵盤' }
    const result = unserialize('bangla|s:3:"ইনপুট সরঞ্জাম";arbic|s:5:"لوحة المفاتيح";chinese|s:2:"中文鍵盤";')
    expect(result).to.deep.equal(expected)
    done()
  })
})
